...
class DisplayScreen:
    ...
    def _draw_gameover(self, c, W, H, t):
        ...
        c.create_rectangle(W//2-100, H-100, W//2+100, H-50, fill=C_BLUE, tags="restart_btn")
        c.create_text(W//2, H-75, text="↺ JOC NOU", font=(FT, 18, "bold"), fill="white", tags="restart_btn")
